...
/**
 * Tests \Xylemical\Type\MapAttribute.
 */
class MapAttributeTest extends TestCase {
  ...
  public function testSanity(): void {
    ...
    $attribute = new MapAttribute('test', TRUE, $factory);
    ...
    $this->assertFalse($constraint->isConstrained([], $path, $violations));
